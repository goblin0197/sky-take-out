...
public class ReportController {
    ...
    public Result<TurnoverReportVO> turnoverStatistics(@DateTimeFormat(pattern = "YYYY-MM-DD") LocalDate beginTime, @DateTimeFormat(pattern = "YYYY-MM-DD") LocalDate endTime){
        TurnoverReportVO turnoverReportVO = reportService.getTurnover(beginTime , endTime);
